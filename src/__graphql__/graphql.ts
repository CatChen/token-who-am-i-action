...
export type ViewerIdentityQueryVariables = Exact<{ [key: string]: never }>;

export type ViewerIdentityQuery = {
  __typename: 'Query';
  viewer: { __typename: 'User'; login: string; globalId: string };
};
...
export type BotAppSlugQuery = {
  ...
  node:
    ...
    | { __typename: 'BlockedByAddedEvent'; id: string }
    | { __typename: 'BlockedByRemovedEvent'; id: string }
    | { __typename: 'BlockingAddedEvent'; id: string }
    | { __typename: 'BlockingRemovedEvent'; id: string }
    | { __typename: 'Bot'; id: string; appSlug: string }
    ...
    | { __typename: 'Discussion'; id: string }
    | { __typename: 'DiscussionCategory'; id: string }
    | { __typename: 'DiscussionComment'; id: string }
    ...
    | { __typename: 'Gist'; id: string }
    | { __typename: 'GistComment'; id: string }
    ...
    | { __typename: 'IssueCommentPinnedEvent'; id: string }
    | { __typename: 'IssueCommentUnpinnedEvent'; id: string }
    | { __typename: 'IssueFieldAddedEvent'; id: string }
    ...
    | { __typename: 'IssueFieldSingleSelect'; id: string }
    | { __typename: 'IssueFieldSingleSelectOption'; id: string }
    | { __typename: 'IssueFieldSingleSelectValue'; id: string }
    | { __typename: 'IssueFieldText'; id: string }
    | { __typename: 'IssueFieldTextValue'; id: string }
    | { __typename: 'IssueType'; id: string }
    | { __typename: 'IssueTypeAddedEvent'; id: string }
    | { __typename: 'IssueTypeChangedEvent'; id: string }
    | { __typename: 'IssueTypeRemovedEvent'; id: string }
    ...
    | { __typename: 'Mannequin'; id: string }
    ...
    | { __typename: 'MergedEvent'; id: string }
    ...
    | { __typename: 'ProjectV2'; id: string }
    ...
    | { __typename: 'PullRequestCommit'; id: string }
    | { __typename: 'PullRequestCommitCommentThread'; id: string }
    ...
    | { __typename: 'ReadyForReviewEvent'; id: string }
    ...
    | { __typename: 'RepositoryCustomProperty'; id: string }
    ...
    | { __typename: 'RepositoryTopic'; id: string }
    ...
    | { __typename: 'RepositoryVulnerabilityAlert'; id: string }
    | { __typename: 'ReviewDismissalAllowance'; id: string }
    | { __typename: 'ReviewDismissedEvent'; id: string }
    ...
    | { __typename: 'WorkflowRunFile'; id: string }
    | null;
};
...
export const ViewerIdentityDocument = new TypedDocumentString(`
...
>;
export const BotAppSlugDocument = new TypedDocumentString(`
